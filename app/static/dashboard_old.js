...
function buildDynamicUI(data) {
    ...
    categories.forEach(cat => {
        ...
        if (cat === 'general') {
            btn.className = 'filter-btn active-category category-toggle px-4 py-1.5 rounded-full text-sm font-medium transition-all';
        } else {
            btn.className = 'filter-btn category-toggle px-4 py-1.5 rounded-full text-sm font-medium transition-all';
        }
